...
public class Default {
	...
	public static void main(String[] args) {
		...
		// choose t                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   he max n-gram level (i.e. if n-gram=3, it will process n-grams 3,2,1)
		int ngram_level = 4;
		int relevancy_Cutoff = 10;	// cutoff point for each topic's frequency (i.e. if 5, remove all topics that occur fewer than 5 times)
		...
		new MatrixHandler(ngram_level,relevancy_Cutoff);
		int[][]matrix = MatrixHandler.matrix;
		
		// overloaded MatrixHandler will take in document-term matrix and generate tf-idf matrix
		...
		// extract DataPoints[] which holds cluster data in the form on index (i.e. clusters are labeled 0,1,2)
		DataPoint[] euclideanpoints = kmeans_euclidean.points;
		DataPoint[] cosinepoints = kmeans_cosine.points;
		// use the confusion matrix to obtain the F1-score and label cluster index with their respective folder names
